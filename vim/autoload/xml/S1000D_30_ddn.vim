let g:xmldata_S1000D_30_ddn = {
\ 'ddn': [['rdf:Description', 'ddnc', 'issdate', 'security', 'datarest', 'dispto', 'dispfrom', 'authrtn', 'mediaid', 'remarks', 'delivlst'], {'id': []}],
...
\ 'mediaid': [[], {'label': []}],
\ 'remarks': [['p'], {}],
\ 'delivlst': [['ddnfilen', 'dmcoricn', 'issno'], {}],
\ 'ddnfilen': [[], {}],
\ 'dmcoricn': [[], {}],

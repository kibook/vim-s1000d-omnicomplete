...
\ 'pmstatus': [['security', 'datarest', 'rpc', 'orig', 'actref', 'applic', 'media', 'qa', 'sbc', 'fic', 'rfu', 'remarks'], {}],
...
\ 'orig': [[], {'origname': [], 'id': []}],
\ 'actref': [['refdm'], {}],
\ 'applic': [['displaytext', 'assert', 'evaluate', 'assert', 'evaluate'], {'applicconf': ['allowed', 'built', 'designed', 'installed', 'manufactured', 'supported'], 'id': [], 'level': [], 'mark': [], 'change': ['add', 'delete', 'modify'], 'rfc': []}],
\ 'displaytext': [['p'], {}],
\ 'assert': [[], {'actidref': [], 'actreftype': ['condition', 'prodattr'], 'actvalues': ['[^~|\s]+(~[^~|\s]+)?(\|[^~|\s]+(~[^~|\s]+)?)*'], 'displayclass': []}],
\ 'evaluate': [['evaluate', 'assert'], {'operator': ['and', 'or'], 'displayclass': []}],
